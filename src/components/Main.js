        ...
        <div className="box-news">
          ...
          <div className="box-user-posts">
            ...
            <div className="text-box-user-posts">
              Tình yêu quê hương đất nước là tình cảm yêu mến và gắn bó sâu sắc,
              chân thành đối với những sự vật, con người thuộc về nơi chúng ta
              sinh ra và lớn lên.
              ...
              <div className="information-box-books">
                ...
                <div className="bottom-box-books">
                  ...
                  <div className="left">
                    ...
                    <div className="text-aveluate">(4.2) (200 đánh giá)</div>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div className="information-user">
                          <div className="box-information">
                            ...
                            <div className="commmet">
                              <a href="#"> Đức Văn Đạt </a> Chào mọi người , có
                              ai đang dùng Mi10s mà bị lỗi Wifi như mình không?
                              Mình mua mi10s ở Mobile city cách đây 1 tuần , máy
                              mình bị lỗi cứ đứng gần cục modem thì mới có sóng
                              wifi
                            </div>
                          </div>
                          <div className="btn-information-user">
                      ...
                      <div className="right">
                        <div className="information-user">
                          <div className="box-information">
                            ...
                            <div className="commmet">
                              <a href="#">Đức Văn Đạt </a> Chào mọi người , có
                              ai đang dùng Mi10s mà bị lỗi Wifi
                            </div>
                          </div>
                          <div className="btn-information-user">
                            <div className="btn-like">Thích</div>
                    ...
                    <div className="information-user">
                      <div className="box-information">
                        ...
                        <div className="commmet">
                          ...
                          mi10s <br />
                          2. Tui cx mua mbc đc 2 thág r, new seal giờ vẫn k lỗi
                          gì Bạn mua máy mới hay cũ? <br />
                          3. Có thể do lỗi Rom, cái này up lại đơn giản, nên thử{" "}
                          <br />
                          4. Nhà tui cũg dùg wifi 1 băng tần và không việc gì,
                          toàn 12 13Mb/s
                        </div>
                      </div>
                      <div className="btn-information-user">
